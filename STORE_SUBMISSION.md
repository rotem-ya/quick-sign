...
| אתר / Web חי | https://rotem-ya.github.io/quick-sign/ |
| **מדיניות פרטיות (URL)** | **https://rotem-ya.github.io/quick-sign/privacy.html** |
| איש קשר / תמיכה | rot4735@gmail.com |

> ⚠️ עמוד מדיניות הפרטיות מתפרסם רק אחרי שהקוד מגיע ל-`main` (ה-Pages בונה
> מ-main). ראה "צעד 0" למטה.

---

## צעד 0 — לפרסם את מדיניות הפרטיות (חובה לשתי החנויות)

שתי החנויות דורשות **URL חי** למדיניות פרטיות. הקובץ `web/privacy.html` כבר
בענף הזה. כדי שיהיה חי בכתובת שלמעלה, צריך שהוא יגיע ל-`main` (ה-workflow
`deploy-web.yml` בונה ומפרסם ל-GitHub Pages מ-main).
→ מזג את הענף `claude/app-store-submission-kr520m` ל-main (או בקש PR).
אחרי הבנייה, ודא שהכתובת נטענת בדפדפן.
...
| מדיניות פרטיות | ✅ נכתבה (`web/privacy.html`) | צריך מיזוג ל-main כדי לפרסם |
